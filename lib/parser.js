  ...
  var result = {
    ...
    parse: function(input, startRule) {
        ...
        if (result11 !== null) {
          ...
          if (result10 !== null) {
            ...
            if (result9 !== null) {
              ...
              var result8 = parse_quoted_string();
              if (result8 !== null) {
                var result3 = result8;
              } else {
                var result3 = null;;
      ...
      function parse_logic() {
        ...
        var result4 = parse_logic_if();
        if (result4 !== null) {
          var result0 = result4;
        } else {
          var result3 = parse_logic_for();
          if (result3 !== null) {
            var result0 = result3;
          } else {
            var result2 = parse_logic_extends();
            if (result2 !== null) {
              var result0 = result2;
            } else {
              var result1 = parse_logic_include();
              if (result1 !== null) {
                var result0 = result1;
              } else {
                var result0 = null;;
      ...
      function parse_logic_if() {
        ...
        if (result3 !== null) {
          ...
          if (result4 !== null) {
            var savedPos2 = pos;
            var result8 = parse_logic_if_else();
            if (result8 !== null) {
            ...
            if (result5 !== null) {
              var result6 = parse_logic_if_close();
              if (result6 !== null) {
